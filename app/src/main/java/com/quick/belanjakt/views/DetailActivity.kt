    ...
    private fun getItemRun(
        ...
        while (c.moveToFirst()) {
            ...
            withContext(Dispatchers.Main){
                setView(nNamaKonten, nHarga,nHargaAwal, nDeskripsi, nFreeOngkir,nRating,nImageUrl)
            }
        }
    }

    private fun setView(nNamaKonten: String?, nHarga: Int, nHargaAwal: Int, nDeskripsi: String?, nFreeOngkir: Int, nRating: Int, nImageUrl: String?) {
